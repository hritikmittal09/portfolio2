const awards = [
  {
    ...
    description:
      "Certified in AWS Cloud Practitioner, showcasing knowledge of core AWS services, security, pricing, and cloud fundamentals.",
  ...
  },
  {
    ...
    description:
      "Achieved Super Contributor status in Hacktoberfest by making significant contributions to open-source projects, demonstrating commitment to the developer community.",
  ...
  },
  {
    ...
    description:
      "Completed the AWS Educate Introduction to Cloud 101 program, gaining foundational skills in AWS cloud services and cloud computing concepts.",
  ...
  },
  {
    ...
    description:
      "Completed the AWS Educate Introduction to Cloud storage program, gaining foundational skills in AWS cloud services and cloud computing concepts.",
  ...
  },
  {
    ...
    description:
      "The OCI Foundations certification validates fundamental knowledge of Oracle Cloud Infrastructure (OCI), covering core services such as compute, storage, networking, databases, security, and cloud governance. It focuses on foundational-level cloud concepts without requiring hands-on technical experience.",
